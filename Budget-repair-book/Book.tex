...
\begin{figure}[t]
\captionwithunits{{\large\strut}Terms of trade added to income growth in the 2000s, but will drag in the next decade\label{fig:FISCAL-5}}%
...
\begin{figure}
\captionwithunits{Personal income tax is projected to grow more strongly than the last decade\label{fig:FISCAL-6}}%
...
Australian governments derive far less revenue from property taxes as a share of GDP than they should. Australia’s property tax take is far below that of some comparable countries (\Vref{fig:PROP-1}).
...
Property is potentially a very large tax base, worth \$8.3 trillion in June 2014. All Australian land was valued at \$4.3 trillion, and buildings and other improvements to land are worth \$4 trillion, with residential land and improvements worth about two-thirds of the total (\Vref{fig:PROP-2}). 

\begin{figure}
\captionwithunits{Australian property values grew quickly this past decades\label{fig:PROP-2}}%
{Real market value of Australian property in trillions (2014 dollars)}%
\includegraphics[width=\columnwidth]{Property-taxes/atlas/figure/Figure2-1.pdf}
...
Land values tend to rise at least as fast as GDP. Over the past 25 years land values almost tripled, growing much faster than GDP (\Cref{fig:PROP-3}).\footcite[][6]{RBA2014SubmissionAffordableHousingInquiry}   Over the last 25 years, property taxes grew faster than other state taxes, and faster than the GST since it was introduced in 2000 (\Cref{fig:PROP-3}).\FOOTNOTE{For more detailed analysis of historical trends in individual state tax revenue growth and revenue volatility, see \Vref{appendix:PROP}.}  
...
\includegraphics[width=1.2\columnwidth]{Property-taxes/atlas/figure/Figure3-1.pdf}
\notes{‘Property levy’ shows the revenues that would have been raised with a broad-based property levy of 0.2 per cent applied to unimproved land values had it been in place since 1990-91; GST is for the period since its introduction in 2000-01 to 2013-14.}
...
Revenues from property taxes tend to be less volatile than stamp duties on property sales (\Vref{fig:PROP-4}). State Treasurers dislike volatility because it makes budgeting more complex. Volatility in property tax revenues can be reduced by levying taxes on the average of recent property valuations. 
...
\begin{bigboxCsep*}{A modest property tax has a similar impact on property development returns as a land tax}{box:PROP-2}{15mm}
...
\source{\textcites{productivity2008assessing}{mangioni2014re}{Treasury2014-Interstate-Comparison-Taxes1415}.}
\end{table}
...
\begin{smallbox}{The South Australian Postponement of Rates Scheme}{box:PROP-3}
...
\begin{figure}
% \captionsetup{margin={0cm,-\extraWd}}
\captionwithunits{The property levy would be less than council rates for most property owners}%
...
\Cref{sec:PROP-3-2} analyses trends in growth in revenues from major state taxes, and the volatility of those revenues for the period 1990-91 to 2013-14, for all states combined. The aggregate trends over 25 years were:
...
\subimport*{Super-tax-targeting/}{Super-tax-targeting-as-chapter}

\part{A GST reform package}\label{part:GST}
\subimport*{GST-reform-package/}{GST-reform-package-as-chapter}

\part{Negative gearing and the capital gains tax discount}
\subimport*{Hot-property-CG-and-NG/}{CGT_and_neg_gearing_final-as-chapter}
