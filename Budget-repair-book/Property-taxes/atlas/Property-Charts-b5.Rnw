...
grplot <- function(...) grattan::grplot(...) + theme_hugh(base_family = "helvet")
@
...
<<Figure2-verso, fig.width=13.2, out.width="13.2in", fig.showtext=TRUE>>=
...
\clearpage
<<Figure3-recto, out.width="13.2in", fig.width=13.2, fig.showtext=TRUE>>=
figure3_p <- 
...
', header = TRUE, as.is = FALSE, sep = "\t", check.names = FALSE) %>%
  ...
  theme(panel.grid.major.y = element_line(),
        ...
        plot.margin = grid::unit(c(0.7, 0.1, 0.5, 11), "lines"),
        strip.background = element_blank(),
        strip.text = element_text(face = "bold", size = 23, color = gpal(2)[1]),
...
grid::grid.draw(gt)
# line across facets
grid.segments(x0 = unit(0.225, "npc"), x1 = unit(1, "npc"), 
              y0 = unit(0.5759, "npc"), y1 = unit(0.5759, "npc"), gp = gpar(lwd = 4.67, lty = "43", lineend = "square", alpha = 1))
grid.segments(x0 = unit(0.153, "npc"), x1 = unit(0.153, "npc"), 
              y0 = unit(0.61, "npc"), y1 = unit(0.7976, "npc"), 
              arrow = arrow(length = unit(0.02, "npc"), type = "closed"), 
              gp = gpar(lwd = 4, type = "closed", lineend = "butt", linejoin = 'mitre', fill = "black"))
grid.segments(x0 = unit(0.153, "npc"), x1 = unit(0.153, "npc"), 
              y0 = unit(0.53529, "npc"), y1 = unit(0.35, "npc"), 
              arrow = arrow(length = unit(0.02, "npc"), type = "closed"), 
              gp = gpar(lwd = 4, type = "closed", lineend = "butt", linejoin = 'mitre', fill = "black"))
grid.text(label = "Revenues\ngrew faster\nthan economy", x = 0.143, y = 0.61, gp = gpar(fontfamily = "helvet", fontface = "bold", lineheight=1, fontsize = 20), hjust = 1, vjust = 0)
grid.text(label = "Revenues\ngrew slower\nthan economy", x = 0.143, y = 0.53529, gp = gpar(fontfamily = "helvet", fontface = "bold", lineheight=1, fontsize = 20), hjust = 1, vjust = 1)
@
\clearpage
<<Figure4-verso, out.width="13.2in", fig.width=13.2, fig.showtext=TRUE>>=
figure4_p <- 
...
', header = TRUE, as.is = FALSE, sep = "\t", check.names = FALSE) %>%
  ...
  geom_text(aes(y = label_y + ifelse(grepl("more volatile", Label), 0.01, -0.01), 
                label = Label, 
