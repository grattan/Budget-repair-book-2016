\documentclass[twoside,english]{palatinob5portrait}
\usepackage{import}


% \title{\raggedleft \begin{tabular}{@{}>{\raggedleft}p{1\linewidth}@{}}Budget Repair\end{tabular}}
\title{\hfill Budget Repair}
% \author{%
% % \centering
% % \begin{tabular}{>{\raggedright}p{0.32\linewidth}>{\centering}p{0.32\linewidth}c>{\raggedleft}p{0.32\linewidth}}
% % John Daley & Danielle Wood & {\hfill Brendan Coates}
% % \end{tabular}%
% % \centerline{\begin{tabular}{ccc}
% % John Daley \tabularnewline\tabularnewline Danielle Wood \tabularnewline\tabularnewline Brendan Coates \tabularnewline\tabularnewline
% % \end{tabular}}
% John Daley, Danielle Wood, and Brendan Coates%
% }
% \author{%
% \centerline{\begin{tabular}{r@{}c@{}l}
% {John Daley\qquad} & {Danielle Wood} & {\qquad Brendan Coates}
% \end{tabular}}
% }
\author{%
...
\begin{figure}
\captionsetup{margin = {0em, -1em}, oneside}
\captionwithunits{Commonwealth Budget forecasts have persistently missed the mark\label{fig:FISCAL-9}}%
...
\fnotes{fig:FISCAL-10}{For 2009 to 2015, the change is the cumulative change over four years from the initial projection to the final outcome. For 2016 to 2018, the change illustrated is the cumulative change from the initial projection to the latest estimate. The change is expressed as a percentage of nominal GDP in the outcome year.}
...
Australian governments derive less revenue from property taxes as a share of GDP than they should. Australia’s property tax take is far below that of some comparable countries (\Cref{fig:PROP-1}).

\begin{figure}
\captionsetup{margin={0cm,-1cm}, oneside}
...
\begin{figure}
\vspace{1.35\baselineskip} % for alignment with RHS
...
\fnotes{fig:PROP-3}{‘Property levy’ shows the revenues that would have been raised with a broad-based property levy of 0.2~per~cent applied to unimproved land values had it been in place since \mbox{1990-91}; GST is for the period since its introduction in 2000-01 to 2013-14.}
...
Property is potentially a very large tax base, worth \$8.3~trillion in June~2014. Australian land in aggregate is valued at \$4.3~trillion, and buildings and other improvements to land are worth \$4 trillion, with residential land and improvements worth about two-thirds of the total (\Cref{fig:PROP-2}). \enlargethispage{0.5\baselineskip} \enlargethispage*{0.5\baselineskip}



Land values tend to rise at least as fast as GDP\@. Over the past 25 years land values almost tripled, growing much faster than GDP, other state taxes, and the GST since its introduction in 2000 (\Cref{fig:PROP-3}).\FOOTNOTE{For more detailed analysis of historical trends in individual state tax revenue growth and revenue volatility, see \Vref{appendix:PROP}.}  
...
\fnotes{fig:PROP-5}{Property levy revenue forecasts are for 2015-16, whereas land tax, council rates, and stamp duty revenues reflect 2013-14 collections. ABS land values for each state in the national accounts may differ, albeit not materially, from state Valuer-General figures due to different approaches, especially for residential land: see \textcite[][419]{ABS2014f}.}
...
\begin{figure}[H]
\captionstarwithunits{Some taxes drag less on economic growth than others\label{fig:PROP-8-left}}%
...
\begin{figure}[H]
\captionstarwithunits{A low rate tax on improvements has little impact on returns on the total investment\label{fig:PROP-9-left}}%
...
\subimport*{Super-tax-targeting/}{b5-palatino-portrait-Super-tax-targeting-as-chapter}

\cleardoublepage\null
\afterpage{\pagecolor{black}\newgeometry{top=0mm}}
\part{A GST reform package}\label{part:GST}
\subimport*{GST-reform-package/}{b5-palatino-portrait-GST-reform-package-as-chapter}

\cleardoublepage\null
\afterpage{\pagecolor{black}\newgeometry{top=0mm}}
\part{Negative~gearing and the capital~gains~tax discount}
\subimport*{Hot-property-CG-and-NG/}{b5-portrait-palatino-CGT_and_neg_gearing_final-as-chapter.tex}
