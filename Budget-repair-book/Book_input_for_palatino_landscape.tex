...
\includegraphics[width=1.05\columnwidth]{Property-taxes/atlas/figure/Figure3-textwidth-1.pdf}
...
Broad-based land taxes are much more efficient than stamp duties (\Vref{box:PROP-1}). Given the inefficiency costs of stamp duties, abolishing all state stamp duties and replacing them with a broad-based land tax could add \$9 billion a year to GDP.\footnote{\gao\ \textcites{KPMGEconotech2011-GST}{ABS2015h}.}
