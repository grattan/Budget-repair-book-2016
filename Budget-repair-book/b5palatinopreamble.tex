...
% \DeclareInstance{enotez-list}{section}{paragraph}{heading=\addchap{#1}, format=\footnotesize, notes-sep = 0.2\baselineskip}
% \setenotez{split=chapter, split-heading=\subsection*{#1}}
