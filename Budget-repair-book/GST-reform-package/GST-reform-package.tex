...
\begin{tikzpicture}[x=0.9\linewidth, y = 0.45\linewidth]
\tikzstyle{every node}=[font=\small, text badly ragged]
    ...
    \node[anchor=north west, inner sep = 0pt, align=left, font={\bfseries\small}] (Bblab) at (0.65, -0.08){ People on higher incomes\\[-1pt] brought into welfare net};
...
\bottomrule
\end{tabularx}
\notes{\mbox{Excludes Temporary Budget Repair Levy (2\% for those earning over \$180,000 until 2016-17).}}
\end{table}
