...
\begin{figure}[!t]
\captionsetup{margin={0cm,-1.10cm}, oneside}
...
\fnotes{fig:GST-6}{Age Pension includes Age and Veteran’s Affairs Pensions. Family payments include Family Tax Benefits and Parenting Payments.}
...
People on most full-welfare payments will be better off on average. The average single person on a full disability payment renting\DEVIATION{ their home} would have 1.4 per cent more to spend after accounting for their additional GST payments. While a couple of Newstart renting their home will have around 0.6 per cent more to spend. These represent modest but real improvements in the standard of living for these people.

Very few people on the full rate of Newstart or the Disability Pension will be undercompensated. Around a third of full Age Pension recipients remain undercompensated, but this group is more likely to have other income sources to draw on to support higher spending (\Cref{tbl:GST-1}). 
...
\midrule
%
\$0& \ -- \  &\$18,200 & 0\% & 0\% & 0\% \\[0.375\baselineskip]
\$18,201& \ -- \  &\$37,000 & 19\%\ & 16.5\% & 17.5\% \\[0.375\baselineskip]
\$37,001& \ -- \  &\$80,000 & 32.5\% & 30.5\% & 31.5\% \\[0.375\baselineskip]
\$80,001& \ -- \  &\$180,000 & 37\% & 37\%\ & 37\%\ \\[0.375\baselineskip]
...
\tikzstyle{every node}=[font=\small, text badly ragged]
    ...
    %
    \draw[-latex, line width = 1pt] (0.15, 0.90)node[anchor=south west, inner sep = -2.5pt, align=left, text width = 3.5cm]{Fixed \$ increase \\ \quad in benefits} -- (0.15, 0.8);
...
\begin{figure}[!t]
%% Figure 
\captionsetup{margin={0cm,-2em}, oneside}
